...
#### Created with LM Studio scaffold: node-typescript-preprocessor

Welcome to your new project! This scaffold is a starting point for building an prompt preprocessor with [LM Studio](https://lmstudio.ai/) SDK. To interact with LM Studio, you should start the LM Studio local server with the command:
